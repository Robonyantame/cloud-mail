const en = {
    ...
    subdomainAdd: 'Add Subdomain Mailbox',
    subdomainOwner: 'Owner: {email}',
    subdomainReceiveOnly: 'These addresses belong to this user and appear in their existing inbox. Receiving only.',
    subdomainNone: 'No subdomains configured. Complete the receiving setup first.',
    subdomainDomain: 'Receiving subdomain',
    subdomainMode: 'Prefix mode',
    subdomainCustom: 'Custom prefixes',
    subdomainRandom: 'Random prefixes',
    subdomainPrefixes: 'Prefixes (one per line, up to 100)',
    subdomainPrefixPlaceholder: 'root\nshopping',
    subdomainCount: 'Number of addresses',
    subdomainResult: '{created} created, {failed} failed',
    subdomainCreated: 'Created',
    subdomainAnother: 'Add more',
    subdomainRetry: 'Retry this request',
    subdomainProcessing: 'Processing. Retry this request after {seconds} seconds.',
    subdomainUncertain: 'The previous result is unconfirmed. Retry this request to avoid creating duplicate addresses.',
    subdomainLoadFailed: 'Could not load subdomains. Close and reopen this dialog.',
    subdomainRequestFailed: 'Request failed. Check your login or try again later.',
    subdomainInvalidForm: 'Select a subdomain and enter 1–100 prefixes or a valid count.',
    subdomainStorageFailed: 'Allow session storage for this site so the creation request can be saved safely.',
    subdomainExpired: 'The previous request is over 24 hours old. Check the user mailbox list before starting a new request.',
    subdomainReviewed: 'Mailboxes checked; start again',
    subdomainErrors: {
        INVALID_PREFIX: 'Invalid prefix format or length',
        PREFIX_BLOCKED: 'Prefix contains a blocked word',
        ADDRESS_UNAVAILABLE: 'Address already reserved or retired',
        QUOTA_EXCEEDED: 'User mailbox limit reached',
        GENERATION_FAILED: 'Could not generate a valid prefix',
        INVALID_USER: 'Owner does not exist, is disabled or deleted',
        DOMAIN_PERMISSION_DENIED: 'User is not authorized for this full subdomain',
        DOMAIN_UNAVAILABLE: 'Subdomain is unavailable',
        ADD_EMAIL_DISABLED: 'Adding mailboxes or multiple mailboxes is disabled',
        ADMIN_REQUIRED: 'Only the site administrator can add subdomain mailboxes',
        ADMIN_UNAVAILABLE: 'Administrator account is unavailable',
        INVALID_MODE: 'Select one prefix mode',
        INVALID_COUNT: 'Create between 1 and 100 mailboxes per request',
        INVALID_REQUEST_ID: 'Invalid request; reopen the dialog',
        REQUEST_TOO_LARGE: 'Input is too long; reduce the number or length of prefixes',
    },
