const zh = {
    ...
    userAccount: '用户邮箱',
    subdomainAdd: '添加子域邮箱',
    subdomainOwner: '归属用户：{email}',
    subdomainReceiveOnly: '新地址归此用户所有，可在现有收件箱中查看邮件，仅用于收信。',
    subdomainNone: '尚未配置可用子域，请先完成子域收信配置。',
    subdomainDomain: '收信子域',
    subdomainMode: '前缀方式',
    subdomainCustom: '指定前缀',
    subdomainRandom: '随机生成',
    subdomainPrefixes: '邮箱前缀（每行一个，最多 100 个）',
    subdomainPrefixPlaceholder: 'root\nshopping',
    subdomainCount: '生成数量',
    subdomainResult: '创建成功 {created} 个，失败 {failed} 个',
    subdomainCreated: '已创建',
    subdomainAnother: '继续添加',
    subdomainRetry: '重试本次创建',
    subdomainProcessing: '正在处理，请在 {seconds} 秒后重试本次创建。',
    subdomainUncertain: '上次创建结果尚未确认，请重试本次创建，避免重复生成地址。',
    subdomainLoadFailed: '无法加载子域列表，请关闭窗口后重新打开。',
    subdomainRequestFailed: '创建请求失败，请检查登录状态或稍后重试。',
    subdomainInvalidForm: '请选择收信子域，并填写 1–100 个前缀或有效的生成数量。',
    subdomainStorageFailed: '浏览器无法保存本次创建信息，请允许此网站使用会话存储后重试。',
    subdomainExpired: '上次请求已超过 24 小时，请先在用户邮箱列表核对已创建地址，再开始新的创建。',
    subdomainReviewed: '已核对邮箱，重新填写',
    subdomainErrors: {
        INVALID_PREFIX: '前缀格式或长度不符合要求',
        PREFIX_BLOCKED: '前缀含禁用词',
        ADDRESS_UNAVAILABLE: '地址已被占用或已退役',
        QUOTA_EXCEEDED: '用户邮箱数量已达上限',
        GENERATION_FAILED: '未能生成符合要求的前缀',
        INVALID_USER: '归属用户不存在、已禁用或已删除',
        DOMAIN_PERMISSION_DENIED: '该用户没有此完整子域的使用权限',
        DOMAIN_UNAVAILABLE: '此子域当前不可用',
        ADD_EMAIL_DISABLED: '系统已关闭新增邮箱或多邮箱功能',
        ADMIN_REQUIRED: '仅站点管理员可以添加子域邮箱',
        ADMIN_UNAVAILABLE: '管理员账号当前不可用',
        INVALID_MODE: '请选择一种前缀方式',
        INVALID_COUNT: '每次只能创建 1–100 个邮箱',
        INVALID_REQUEST_ID: '创建请求无效，请重新打开窗口',
        REQUEST_TOO_LARGE: '输入内容过长，请减少前缀数量或长度',
    },
    deleteUser: '删除账户',
    deleteUserBtn: '删除账户',
    changePassword: '修改密码',
